/**
  ******************************************************************************
  * @file           : led.c
  * @brief          : TFTLCD device driver file
  * @author         : Joe-joe
  * @date           : 2020/2/25
  ******************************************************************************
  * @attention
  *
  * This program is only for learning and cannot be used for any other purpose 
  * without the permission of the author.
  * 2.8寸/3.5寸/4.3寸/7寸 TFTLCD device driver
  * The supported IC models include: ILI9341/NT35310/NT35510/SSD1963 etc.
  * 
  ******************************************************************************
**/
#include "lcd.h"
...
void LCD_Init(void)
{
	...
	HAL_GPIO_WritePin(LCD_BL_GPIO_Port,LCD_BL_Pin,GPIO_PIN_SET);    //将LCD_BL_Pin置高电平，点亮背光
	LCD_Clear(WHITE);
